...
class GregorianModel {
    ...
    final int? code;
    final String? status;
    final Map<String, List<GregorianYear>> data;

    factory GregorianModel.fromJson(Map<String, dynamic> json){ 
        return GregorianModel(
            code: json["code"],
            status: json["status"],
            data: Map.from(json["data"]).map((k, v) => MapEntry<String, List<GregorianYear>>(k, v == null ? [] : List<GregorianYear>.from(v!.map((x) => GregorianYear.fromJson(x))))),
        );
    }
...
class GregorianYear {
    ...
    factory GregorianYear.fromJson(Map<String, dynamic> json){ 
